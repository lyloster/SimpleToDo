...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int EDIT_CODE_TEXT = 20;
    List<String> items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemsAdapter.OnClickListener onClickListener = new ItemsAdapter.OnClickListener() {
            ...
            public void onItemClicked(int position) {
                ...
                startActivityForResult(i, EDIT_CODE_TEXT);
        ...
        ItemsAdapter.OnLongClickListener longClickListener = new  ItemsAdapter.OnLongClickListener() {
            ...
            public void onItemLongClicked(int position) {
                ...
                // Notify the adaptor from which position we deleted the item
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (resultCode == RESULT_OK && requestCode == EDIT_CODE_TEXT) {
            // Retrieve the updated text value
            String itemText = data.getStringExtra(KEY_ITEM_TEXT);
            // Extract the original position of the edited item from the position key
            int position = data.getExtras().getInt(KEY_ITEM_POSITION);

            // Update the model with the new itemText
            items.set(position, itemText);
            // Notify the adapter so that the recycler view know something has changed
    ...
    // This function will load items by reading line by line of the data file
